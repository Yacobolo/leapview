...
var ReportCanvas = class extends i4 {
  constructor() {
    ...
    this.onZoomCommand = (event) => {
      ...
      this.setZoomMode(detail.mode ?? (detail.scale !== void 0 ? "custom" : this.zoomMode));
    };
  }
  static {
    this.styles = i`
  ...
  connectedCallback() {
    ...
    document.addEventListener("ld-report-zoom-command", this.onZoomCommand);
  ...
  disconnectedCallback() {
    document.removeEventListener("ld-report-zoom-command", this.onZoomCommand);
...
__decorateClass([
  r5()
], ReportCanvas.prototype, "zoomMode", 2);
var ReportZoom = class extends i4 {
  constructor() {
    super(...arguments);
    this.mode = storedZoomMode();
    this.scale = storedCustomScale();
    this.onZoomState = (event) => {
  ...
  connectedCallback() {
    super.connectedCallback();
    document.addEventListener("ld-report-zoom-state", this.onZoomState);
  }
  disconnectedCallback() {
    document.removeEventListener("ld-report-zoom-state", this.onZoomState);
    super.disconnectedCallback();
  }
  command(detail) {
...
__decorateClass([
  r5()
], ReportZoom.prototype, "mode", 2);
__decorateClass([
  r5()
], ReportZoom.prototype, "scale", 2);
...
function zoomIcon(name) {
  switch (name) {
    case "fit-page":
      return w`<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 7V5a2 2 0 0 1 2-2h2"></path><path d="M17 3h2a2 2 0 0 1 2 2v2"></path><path d="M21 17v2a2 2 0 0 1-2 2h-2"></path><path d="M7 21H5a2 2 0 0 1-2-2v-2"></path></svg>`;
    case "minus":
      return w`<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 12h14"></path></svg>`;
    case "plus":
      return w`<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 5v14"></path><path d="M5 12h14"></path></svg>`;
  }
}
