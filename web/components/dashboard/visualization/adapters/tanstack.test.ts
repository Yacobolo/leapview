...
test('TanStack adapter derives semantic row interactions from the typed IR', () => {
  const envelope = {
    schemaVersion: 5, visualID: 'orders', rendererID: 'tanstack', specRevision: 'sha256:test', dataRevision: 3,
    spec: {
...
test('TanStack adapter leaves row interaction disabled when the IR declares none', () => {
  const envelope = {
    schemaVersion: 5, visualID: 'orders', rendererID: 'tanstack', specRevision: 'sha256:test', dataRevision: 1,
    spec: {
...
test('TanStack matrix adapter renders dynamic window schema columns with compiled formatting', () => {
  const envelope = {
    schemaVersion: 5, visualID: 'matrix', rendererID: 'tanstack', specRevision: 'sha256:matrix', dataRevision: 2,
    spec: {
