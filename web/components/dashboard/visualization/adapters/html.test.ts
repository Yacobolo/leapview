...
test('HTML KPI values use the field formatting contract', () => {
  const envelope = {
    schemaVersion: 7, visualID: 'revenue', rendererID: 'html', specRevision: 'sha256:test', dataRevision: 1,
    spec: {
...
test('HTML KPI formatting resolves semantic backgrounds, readable text, and redundant status cues', () => {
  const envelope = {
    schemaVersion: 7, visualID: 'health', rendererID: 'html', specRevision: 'sha256:health', dataRevision: 1,
    spec: {
