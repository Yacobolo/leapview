...
type StorageSignal = {
  ...
  tables?: StorageTable[]
  selectedKey?: string
  selectedTable?: StorageTable | null
}
...
class StorageExplorer extends LitElement {
  @property({ attribute: false }) storage: StorageSignal | null = null
  @property({ attribute: 'storage' }) storageAttribute = ''
  ...
  private get resolvedStorage(): StorageSignal {
    if (this.storage) return this.storage
    if (this.storageAttribute) {
      try {
        return JSON.parse(this.storageAttribute) as StorageSignal
      } catch {
        return {}
      }
    }
  ...
  private renderTableButton(table: StorageTable, selectedKey: string) {
  ...
  private renderSelectedTable(table: StorageTable) {
  ...
  private selectTable(table: StorageTable): void {
...
function filterTables(tables: StorageTable[], query: string): StorageTable[] {
...
function groupTables(tables: StorageTable[]): DatabaseGroup[] {
...
function sumKnownRows(tables: StorageTable[]): string {
  let total = 0
  let known = 0
  for (const table of tables) {
...
const storageExplorerStyles = `
  ...
  ld-storage-explorer .storage-explorer {
    display: grid;
  ...
  ld-storage-explorer .storage-browser,
  ld-storage-explorer .storage-detail {
    min-width: 0;
    min-height: 0;
  }
  ...
  ld-storage-explorer .storage-browser-header {
    display: grid;
    min-height: 3rem;
  ...
  ld-storage-explorer .storage-detail-header,
  ld-storage-explorer .storage-columns-header {
    display: flex;
    align-items: center;
  ...
  ld-storage-explorer h2,
  ld-storage-explorer h3,
  ld-storage-explorer p,
  ld-storage-explorer dl {
    margin: 0;
  }
  ...
  ld-storage-explorer .storage-logo {
    display: grid;
    width: 1.875rem;
    height: 1.875rem;
    place-items: center;
  ...
  ld-storage-explorer .storage-browser-header > span:not(.storage-logo),
  ld-storage-explorer .storage-detail-header > span,
  ld-storage-explorer .storage-columns-header > span {
    flex: none;
    border: var(--ld-border-muted);
    border-radius: var(--ld-radius-small);
    background: var(--ld-bg-panel);
  ...
  ld-storage-explorer .storage-search {
    position: relative;
    display: block;
    border-bottom: var(--ld-border-muted);
    padding: 0.625rem;
  ...
  ld-storage-explorer .storage-search-icon {
    position: absolute;
    left: 1.125rem;
    top: 50%;
    display: grid;
  ...
  ld-storage-explorer .storage-search input {
    min-height: 2.125rem;
    width: 100%;
    border: var(--ld-border-default);
    border-radius: var(--ld-radius-small);
  ...
  ld-storage-explorer .storage-search input:focus {
    border-color: var(--ld-line-accent);
    background: var(--ld-bg-control-hover);
  }

  ld-storage-explorer .storage-tree {
    min-height: 0;
    overflow: auto;
    padding: 0.25rem;
  }

  ld-storage-explorer .storage-db {
    display: grid;
  }

  ld-storage-explorer .storage-db + .storage-db {
    margin-top: 0.125rem;
  }

  ld-storage-explorer summary {
    display: grid;
    min-height: 1.9rem;
  ...
  ld-storage-explorer summary::-webkit-details-marker {
    display: none;
  }

  ld-storage-explorer summary:hover,
  ld-storage-explorer summary:focus-visible {
    background: var(--ld-bg-hover);
    outline: 0;
  }

  ld-storage-explorer .storage-db > summary {
    margin-bottom: 0.125rem;
  }

  ld-storage-explorer .storage-schema > summary {
    min-height: 1.75rem;
    font-size: 0.8125rem;
    font-weight: 700;
  }

  ld-storage-explorer .storage-schema > summary.is-selected-schema {
    background: var(--ld-bg-accent-muted);
    color: var(--ld-fg-default);
  }

  ld-storage-explorer summary span:not(.storage-chevron):not(.storage-node-icon) {
    overflow: hidden;
    text-overflow: ellipsis;
    white-space: nowrap;
  }

  ld-storage-explorer summary em {
    border-radius: var(--ld-radius-small);
  ...
  ld-storage-explorer .storage-chevron,
  ld-storage-explorer .storage-node-icon {
    display: grid;
    place-items: center;
    color: var(--ld-fg-muted);
  }

  ld-storage-explorer details[open] > summary .storage-chevron {
    transform: rotate(90deg);
  }

  ld-storage-explorer .storage-schema {
    display: grid;
    margin-left: 1rem;
  }

  ld-storage-explorer .storage-table-list {
    display: grid;
    gap: 0.0625rem;
    margin-left: 1.55rem;
  ...
  ld-storage-explorer .storage-table-button {
    display: grid;
    min-height: 1.75rem;
    width: 100%;
  ...
  ld-storage-explorer .storage-table-button:hover,
  ld-storage-explorer .storage-table-button:focus-visible {
    background: var(--ld-bg-control-hover);
    outline: 0;
  }

  ld-storage-explorer .storage-table-button.is-selected {
    border-left-color: var(--ld-line-accent);
    background: var(--ld-bg-accent-muted);
  }

  ld-storage-explorer .storage-table-icon {
    display: grid;
    width: 1rem;
    height: 1rem;
    place-items: center;
  ...
  ld-storage-explorer .storage-table-icon-view {
    color: var(--ld-fg-link);
  }

  ld-storage-explorer .storage-table-button span {
    min-width: 0;
  }

  ld-storage-explorer .storage-table-button strong,
  ld-storage-explorer .storage-table-button small {
    display: block;
    overflow: hidden;
    text-overflow: ellipsis;
    white-space: nowrap;
  ...
  ld-storage-explorer .storage-detail-header nav {
    display: flex;
    min-width: 0;
    align-items: center;
    gap: 0.375rem;
  ...
  ld-storage-explorer .storage-detail-header nav > span {
    min-width: 0;
  }

  ld-storage-explorer .storage-detail-header nav > span:not(.storage-breadcrumb-separator):not(.storage-breadcrumb-table) {
    overflow: hidden;
    color: var(--ld-fg-muted);
    text-overflow: ellipsis;
    white-space: nowrap;
  ...
  ld-storage-explorer .storage-breadcrumb-separator {
    display: grid;
    flex: none;
    place-items: center;
    color: var(--ld-fg-muted);
  ...
  ld-storage-explorer .storage-breadcrumb-table {
    display: inline-flex;
    align-items: center;
    gap: 0.375rem;
  }

  ld-storage-explorer .storage-metrics {
    display: flex;
    min-height: 2.5rem;
    align-items: center;
    gap: 1rem;
  ...
  ld-storage-explorer .storage-metrics div {
    display: flex;
  ...
  ld-storage-explorer .storage-columns {
    display: grid;
    min-height: 0;
  ...
  ld-storage-explorer .storage-column-table-wrap {
    min-height: 0;
    overflow: auto;
  }

  ld-storage-explorer .storage-column-table {
    width: 100%;
    min-width: 42rem;
  ...
  ld-storage-explorer .storage-schema-table {
    min-width: 50rem;
  }

  ld-storage-explorer th,
  ld-storage-explorer td {
    border-bottom: var(--ld-border-muted);
  ...
  ld-storage-explorer th:first-child,
  ld-storage-explorer td:first-child {
    width: 4rem;
    color: var(--ld-fg-muted);
    text-align: right;
  }

  ld-storage-explorer .storage-schema-table th:nth-child(4),
  ld-storage-explorer .storage-schema-table td:nth-child(4),
  ld-storage-explorer .storage-schema-table th:nth-child(5),
  ld-storage-explorer .storage-schema-table td:nth-child(5),
  ld-storage-explorer .storage-schema-table th:nth-child(6),
  ld-storage-explorer .storage-schema-table td:nth-child(6) {
    text-align: right;
  }

  ld-storage-explorer .storage-schema-table-link {
    display: inline-flex;
    max-width: 100%;
    align-items: center;
    gap: 0.375rem;
  ...
  ld-storage-explorer .storage-schema-table-link:hover,
  ld-storage-explorer .storage-schema-table-link:focus-visible {
    color: var(--ld-fg-link);
    outline: 0;
  }

  ld-storage-explorer .storage-schema-table-link span {
    overflow: hidden;
    text-overflow: ellipsis;
    white-space: nowrap;
  }

  ld-storage-explorer code {
  ...
  ld-storage-explorer .storage-muted,
  ld-storage-explorer .storage-empty {
    color: var(--ld-fg-muted);
  }
...
customElements.define('ld-storage-explorer', StorageExplorer)
