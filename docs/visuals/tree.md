...
Add delivery speed as an intermediate level, use `initial_depth` to limit the initial expansion, and set `orientation` to fit the available reading direction.
