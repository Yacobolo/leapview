...
Read [Runtime architecture](/docs/architecture/runtime), [Datastar signal flow](/docs/architecture/datastar), [Visualization target architecture](/docs/architecture/visual-plugins), and [Storage architecture](/docs/storage-architecture) for deeper boundaries.
