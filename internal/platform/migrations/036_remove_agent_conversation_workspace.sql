...
-- +goose Up
-- Conversations are global principal-owned records. Workspace selection belongs
-- to individual governed tool calls, not conversation persistence.

PRAGMA foreign_keys = OFF;

CREATE TABLE agent_conversations_global (
  id TEXT PRIMARY KEY,
...
INSERT INTO agent_conversations_global (
  id, principal_id, title, status, metadata_json, transcript_json,
