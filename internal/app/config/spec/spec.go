...
var settings = []Setting{
	...
	{Name: "LEAPVIEW_SITE_MAP_ASSETS_ROOT", Type: TypeString, Category: "site", Scope: "public site", Description: "Absolute path to the complete immutable MapLibre asset package; configured production sites verify it before listening and during readiness checks.", Example: "/.data/map-assets", Lifecycle: "supported"},
