...
func compileVisualCalculations(spec visualizationir.VisualizationSpec, authored []reportdef.VisualCalculation) error {
...
func compileVisualCalculation(kind string, authored reportdef.VisualCalculation, fields map[string]visualizationir.VisualizationField, calculationIDs map[string]int) (visualizationir.VisualizationCalculation, error) {
