...
func widgetLayoutContract(authored *report.Dashboard, component dashboard.PageVisual) (dashboardlayout.ContractID, []dashboardlayout.Feature, bool) {
...
func kpiLayoutFeatures(visual report.Visual) []dashboardlayout.Feature {
