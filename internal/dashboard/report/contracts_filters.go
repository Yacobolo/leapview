...
func (d *Dashboard) FilterAppliesToTarget(model *semanticmodel.Model, filter FilterDefinition, targetKind, targetID string) (bool, error) {
...
func (d *Dashboard) TargetBaseTable(model *semanticmodel.Model, targetKind, targetID string) (string, error) {
	switch targetKind {
	case "visual":
...
func visualQueryBaseTable(model *semanticmodel.Model, query VisualQuery) (string, error) {
...
func tableQueryBaseTable(model *semanticmodel.Model, table TableVisual) (string, error) {
...
func measureRefsBaseTable(model *semanticmodel.Model, measures []FieldRef) (string, error) {
	base := ""
	grain := ""
...
func metricMeasureForRef(model *semanticmodel.Model, ref FieldRef) (semanticmodel.MetricMeasure, error) {
