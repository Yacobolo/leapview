...
func normalizeTableFields(name string, model *semanticmodel.Model, table *TableVisual) error {
...
func normalizeDataTableFields(name string, model *semanticmodel.Model, table *TableVisual) error {
...
func normalizeTableFormatting(model *semanticmodel.Model, table *TableVisual) {
