				...
				h.Div(h.Class("site-hero-layout"),
					...
					g.El("figure", h.Class("site-product-frame"),
						...
						h.Img(
							...
							h.Alt("LibreDash Visual Showcase overview with KPIs, line, donut, and bar charts, and an analytical table"),
							g.Attr("width", "1440"),
							g.Attr("height", "900"),
						...
						g.El("figcaption", h.Class("site-product-caption"), g.Text("The first page of the real Visual Showcase dashboard, rendered from a versioned project.")),
					),
				),
