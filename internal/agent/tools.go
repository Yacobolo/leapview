...
func (s *Service) filterToolDefinitions(scope Scope, tools []agentcore.ToolDefinition) []agentcore.ToolDefinition {
	...
	filtered := make([]agentcore.ToolDefinition, 0, len(tools))
