// Package snapshot defines the neutral, immutable validation snapshots stored
// at serving-state boundaries.
package snapshot
...
func DecodeAccessPolicy(data []byte) (AccessPolicy, error) {
