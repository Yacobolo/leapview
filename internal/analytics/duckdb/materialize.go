...
func (r *SourceRuntime) RegisterSources(ctx context.Context, model *semanticmodel.Model) error {
	return RegisterSourceViews(ctx, r.db.SQLDB(), model, r.dataDir, r.attachedConnections)
}
