...
var settings = []Setting{
	...
	{Name: "LIBREDASH_ENVIRONMENT", Field: "Environment", Type: TypeString, Category: "server", Scope: "serve,admin", Description: "Single serving environment permanently bound to this LeapView instance.", Example: "prod", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LIBREDASH_IMAGE", Type: TypeString, Category: "deployment", Scope: "Hetzner provisioner", Description: "Immutable LeapView OCI image reference consumed by deployment tooling.", Example: "ghcr.io/yacobolo/libredash@sha256:0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef", Lifecycle: "tooling"},
	...
	{Name: "LIBREDASH_TARGET", Field: "Target", Type: TypeString, Category: "client", Scope: "client commands", Description: "Default LeapView API target URL.", Runtime: true, Lifecycle: "supported", Commented: true},
