...
var settings = []Setting{
	...
	{Name: "LEAPVIEW_DUCKDB_NODE_MEMORY_MAX_BYTES", Field: "DuckDBNodeMemoryMaxBytes", Type: TypeInt64, Default: "2684354560", Category: "analytics", Scope: "serve", Description: "Node-wide DuckDB buffer-manager memory budget divided across open engines.", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_DUCKDB_NODE_TEMP_MAX_BYTES", Field: "DuckDBNodeTempMaxBytes", Type: TypeInt64, Default: "10737418240", Category: "analytics", Scope: "serve", Description: "Node-wide DuckDB temporary-storage budget divided across open engines.", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_DUCKDB_NODE_MAX_THREADS", Field: "DuckDBNodeMaxThreads", Type: TypeInt, Default: "5", Category: "analytics", Scope: "serve", Description: "Node-wide DuckDB execution-thread budget divided across open engines.", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_DUCKDB_TEMP_DIR", Field: "DuckDBTempDir", Type: TypeString, Category: "analytics", Scope: "serve", Description: "Private root for bounded per-engine DuckDB temporary directories; defaults beneath LEAPVIEW_HOME.", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_QUERY_CACHE_RUNTIME_MAX_ENTRIES", Field: "QueryCacheRuntimeMaxEntries", Type: TypeInt, Default: "256", Category: "analytics", Scope: "serve", Description: "Maximum cached query-result entries retained by one serving generation.", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_QUERY_CACHE_RUNTIME_MAX_BYTES", Field: "QueryCacheRuntimeMaxBytes", Type: TypeInt64, Default: "67108864", Category: "analytics", Scope: "serve", Description: "Maximum estimated query-result bytes retained by one serving generation.", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_QUERY_CACHE_WORKSPACE_MAX_ENTRIES", Field: "QueryCacheWorkspaceMaxEntries", Type: TypeInt, Default: "512", Category: "analytics", Scope: "serve", Description: "Maximum cached query-result entries retained across one workspace's generations.", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_QUERY_CACHE_WORKSPACE_MAX_BYTES", Field: "QueryCacheWorkspaceMaxBytes", Type: TypeInt64, Default: "134217728", Category: "analytics", Scope: "serve", Description: "Maximum estimated query-result bytes retained across one workspace's generations.", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_QUERY_CACHE_NODE_MAX_ENTRIES", Field: "QueryCacheNodeMaxEntries", Type: TypeInt, Default: "2048", Category: "analytics", Scope: "serve", Description: "Maximum cached query-result entries retained by the node.", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_QUERY_CACHE_NODE_MAX_BYTES", Field: "QueryCacheNodeMaxBytes", Type: TypeInt64, Default: "536870912", Category: "analytics", Scope: "serve", Description: "Maximum estimated query-result bytes retained by the node.", Runtime: true, Lifecycle: "supported", Commented: true},
